...
from app.ml.qprobe_adaptive_physics_features import build_qprobe_adaptive_physics_feature_vector
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=ARTIFACTS_DIR / "qprobe_adaptive_physics_dataset.pt")
    ...
    print(f"saved {len(dataset)} adaptive physics ML-QProbe samples to {args.output}")
