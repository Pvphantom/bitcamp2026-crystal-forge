    ...
    *,
    ...
    for _ in range(epochs):
        ...
        val_score = (
            ...
            + 0.5 * max(0.0, min(0.5 * calibration["predicted_stop_fraction"] + 0.02, 0.15) - val_metrics["predicted_stop_fraction"])
...
def main() -> None:
    ...
    parser.add_argument("--model-out", type=Path, default=Path("backend/artifacts/qprobe_adaptive_stepwise_mlp.pt"))
    parser.add_argument("--metrics-out", type=Path, default=Path("backend/artifacts/qprobe_adaptive_stepwise_metrics.json"))
